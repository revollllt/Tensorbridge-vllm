...
class DeviceHeuristics:
    ...
    def get_config(
        ...
        use_stream_k: bool | None = None,  # manual override; base path derives, ignores
    ):
    ...
    @classmethod
    def estimate_num_blocks_m(cls, meta: "TensorBridgeLayerMeta", shape_m: int, block_shape_m: int):
        if not meta.num_experts:
