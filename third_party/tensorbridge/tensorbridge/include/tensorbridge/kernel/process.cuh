...
CUDA_INLINE void tensorbridge_pack_weight(uint32_t *in_arr, uint32_t *out_arr) {
...
__global__ void weight_repack_nk(
  ...
  tensorbridge_pack_weight<kNumBitsB, kNumBitsA>(reinterpret_cast<uint32_t *>(tmp), out_arr);
